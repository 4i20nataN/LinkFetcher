    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          `default-src 'self'; img-src 'self' https: data:; media-src 'self' https: data:; style-src 'self' 'unsafe-inline' https:; font-src 'self' https:; ${scriptSrc}; connect-src 'self' https: http:;`
        ]
      }
    });
  });
